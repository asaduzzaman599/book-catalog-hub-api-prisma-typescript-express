...
const signIn = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    const userExist = yield prisma_client_1.default.user.findUnique({ where: {
            email: payload.email
        } });
    if (!userExist)
        throw new api_error_1.default(http_status_1.default.NOT_FOUND, 'User does not exist!');
    if ((userExist === null || userExist === void 0 ? void 0 : userExist.password) && !(yield bcrypt_1.default.compare(payload.password, userExist === null || userExist === void 0 ? void 0 : userExist.password)))
        throw new api_error_1.default(http_status_1.default.BAD_REQUEST, 'Email or Password not matched!');
    const accessToken = jwt_helpers_1.JwtHelpers.generateToken({ userId: userExist === null || userExist === void 0 ? void 0 : userExist.id, role: userExist === null || userExist === void 0 ? void 0 : userExist.role });
    return accessToken;
});
